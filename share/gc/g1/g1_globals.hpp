...
#define GC_G1_FLAGS(develop,                                                \
  ...
  develop(bool, G1VerifyBitmaps, false,                                     \
          "Verifies the consistency of the marking bitmaps")                \
                                                                            \
  experimental(bool, G1NVRAMIsReallyDRAM, false,                            \
          "Make NVRAM node really a DRAM node for G1 collector")            \
                                                                            \
  experimental(bool, G1DRAMIsReallyNVRAM, false,                            \
          "Make DRAM node really an NVRAM node for G1 collector")           \
                                                                            \
